...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="${url}/icons/icon-48x48.png"/>
        <link rel="manifest" href="${url}/manifest.webmanifest"/>
        <meta name="theme-color" content="#e2de00"/>
        <meta property="og:image" content="${url}/static/puente-logo-2cdbb018c739a2bb874efed453394f9d.svg" />
        <meta property=”og:title” content=”Puente Technology and Design” />
        <link as="script" rel="preload" href="${url}/component---src-pages-index-js-1fbb9bcf35ebe93dc606.js"/>
        <link as="script" rel="preload" href="${url}/0-ba6c40f50b811c3cea0f.js"/>
        <link as="script" rel="preload" href="${url}/app-1c8ddf60f0ad508c4a5a.js"/>
        <link as="script" rel="preload" href="${url}/webpack-runtime-e1d8522d87107242b6ed.js"/>
        <link rel="preload" href="${url}/static/d/173/path---index-6a9-NZuapzHg3X9TaN1iIixfv1W23E.json" as="fetch" crossOrigin="use-credentials"/>
    </head>
    <body>
        <div id="___gatsby">
